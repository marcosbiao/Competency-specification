...
Repositório dedicado à especificação de competências para a disciplina de **Introdução à Programação**, utilizando a metodologia **Competency Specification Process (CSP)** [link para repositorio CSP](https://github.com/eduknowgpt/OCSP).
